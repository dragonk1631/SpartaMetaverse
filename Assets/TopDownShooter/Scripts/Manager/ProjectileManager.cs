...
namespace TopDown
{
    public class ProjectileManager : MonoBehaviour
    {
        ...
        public void ShootBullet(RangeWeaponHandler rangeWeaponHandler, Vector2 startPositon, Vector2 direction)
        {
            GameObject origin = projectilePrefabs[rangeWeaponHandler.BulletIndex];
            GameObject obj = Instantiate(origin, startPositon, Quaternion.identity);
